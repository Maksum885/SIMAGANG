...
<div class="max-w-3xl mx-auto p-6 bg-white rounded-2xl shadow text-2xl">
    <h2 class="text-4xl underline font-bold text-gray-800 mb-8">Profil Guru Pembimbing</h2>

    <div class="overflow-hidden rounded-xl border border-gray-200">
        <table class="min-w-full bg-gray-50">
            <tbody class="divide-y divide-gray-200">
                <tr class="bg-white hover:bg-gray-100">
                    <td class="px-4 py-3 font-semibold text-gray-600 w-1/3">NIP</td>
                ...
                <tr class="bg-white hover:bg-gray-100">
                    ...
                    <td class="px-4 py-3 font-semibold text-gray-600 w-1/3">:</td>
                    <td class="px-4 py-3 text-gray-800">guru@gmail.com</td>
                </tr>
                <tr class="bg-gray-50 hover:bg-gray-100">
