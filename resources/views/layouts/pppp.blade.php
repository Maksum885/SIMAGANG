...
<head>
    ...
    <title>Profil Pembimbing Perusahaan</title>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        <bing class="text-xl font-semibold text-gray-800">Profil Pembimbing Perusahaan</bing>
                        <div>
                            ...
                            <div class="bg-white rounded-lg shadow-md p-6">
                                ...
                                <form class="space-y-4">
                                    <div class="grid grid-cols-1 gap-4">
                                        <div>
                                            <label for="idk" class="block text-sm font-medium text-gray-700 mb-1">Id Karyawan</label>
                                            <input type="text" id="idk" name="idk" value="2219" class="bg-gray-200 border border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5" readonly>
                                        </div>

                                        <div>
                                            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nama Lengkap</label>
                                            <input type="text" id="name" name="name" value="Andi Saputra" class="bg-gray-200 border border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5" readonly>
                                        </div>
                                        <div>
                                            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nama Perusahaan</label>
                                            <input type="text" id="name" name="name" value="PT. Teknologi Maju" class="bg-gray-200 border border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5" readonly>
                                        </div>
