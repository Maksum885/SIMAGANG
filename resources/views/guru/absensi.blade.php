...
@section('content')
<div class="text-2xl">
    <h1 class="text-4xl font-bold mb-6 underline">Data Absensi</h1>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="px-4 py-2 border">
                        <span class="bg-green-100 text-green-700 px-2 py-1 rounded text-lg">Hadir</span>
                    </td>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border">01/08/2025</td>
                    <td class="px-4 py-2 border">
                        <span class="bg-yellow-100 text-yellow-700 px-2 py-1 rounded text-lg">Izin</span>
                    </td>
