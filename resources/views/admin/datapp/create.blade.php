...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold mb-6 text-gray-800">Tambah Pembimbing Perusahaan</h1>
        ...
        <form action="{{ route('admin.datapp.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="id_karyawan" value="{{ old('id_karyawan') }}"
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required placeholder="Masukkan ID karyawan">
                </div>
                ...
                <div>
                    ...
                    <input type="tel" name="kontak" value="{{ old('kontak') }}"
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
