    ...
    <div class="relative">
       ...
       <!-- Dropdown Menu -->
        <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
            <a href="{{ route('industri.profilpi') }}" class="cursor-pointer w-full text-left text-2xl font-medium px-5 py-4 hover:bg-gray-100 flex items-center border-b gap-4">
