...
namespace App\Http\Controllers\PembimbingKampus;
...
{
    /**
     * Menampilkan daftar seluruh pemagang untuk pembimbing.
     * Juga mendukung pencarian berdasarkan beberapa kolom.
     */
    public function index(Request $request)
    {
        ...
        return view('pk.peserta', compact('pemagangs'));
